$(function(){  
	...
	$.ajax({
		type:"GET",//请求类型
		url:"/dev/app/list/flatformlist.json",//请求的url
	...
	$.ajax({
		type:"GET",//请求类型
		url:"/dev/app/list/categnull.json",//请求的url
		data:{pid:null},//请求参数
		dataType:"json",//ajax接口（请求url）返回的数据类型
		success:function(data){//data：返回数据（json对象）
			$("#categoryLevel1").html("");
	...
	$("#categoryLevel1").change(function(){
		...
		if(categoryLevel1 != '' && categoryLevel1 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"/dev/app/list/categ"+categoryLevel1+".json",//请求的url
	...
	$("#categoryLevel2").change(function(){
		...
		if(categoryLevel2 != '' && categoryLevel2 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"/dev/app/list/categ"+categoryLevel2+".json",//请求的url
