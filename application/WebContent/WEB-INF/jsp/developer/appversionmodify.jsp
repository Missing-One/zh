...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>修改APP最新版本信息 <i class="fa fa-user"></i><small>${logged.devname}</small></h2>
            <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>历史版本列表</h2>
						...
						<tbody>
							<c:forEach var="appVersion" items="${appVersionList }" varStatus="status">
								<tr role="row" class="odd">
									<td tabindex="0" class="sorting_1">${appVersion.app.softwarename}</td>
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
			...
			<div id="uploadfile" style="display: none">
				<input id="attach" type="file" class="form-control col-md-7 col-xs-12" name="file" value="${appVersion.apkfilename}">
